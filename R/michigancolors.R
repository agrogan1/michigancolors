...
#'
#' @param x colors. Defaults to all. Allowable colors are: "blue", "maize", "tappan red", "ross school orange", "rackham green", "wave field green", "taubman teal", "arboretum blue", "ann arbor amethyst", "matthaei violet", "umma tan", "burton tower beige", "angell hall ash", and "law quad stone".
